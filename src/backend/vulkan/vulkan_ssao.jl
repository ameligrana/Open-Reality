...
function vk_destroy_ssao_pass!(device::Device, ssao::VulkanSSAOPass)
    ...
    destroy_pipeline(device, ssao.ssao_pipeline.pipeline)
    destroy_pipeline_layout(device, ssao.ssao_pipeline.pipeline_layout)
    destroy_pipeline(device, ssao.blur_pipeline.pipeline)
    destroy_pipeline_layout(device, ssao.blur_pipeline.pipeline_layout)
    destroy_buffer(device, ssao.kernel_ubo)
    free_memory(device, ssao.kernel_ubo_memory)
    return nothing
end
